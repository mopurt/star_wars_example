...
TextStyle _progressTextStyle = const TextStyle(
    ...
    _messageStyle = TextStyle(color: Colors.grey[900], fontWeight: FontWeight.bold, fontSize: 18.0);
...
Widget _progressWidget = Image.asset('resources/images/double_ring_loading_io.gif',);
